...
function validateOnboarding(form) {
  ...
  required('bank_account_type', 'Account type');
  ...
  } else if (!form.bank_routing_raw && form.payment_method === 'direct_deposit') {
    errors.bank_routing_raw = 'Routing number is required for direct deposit';
  }
  ...
  } else if (!form.bank_account_raw && form.payment_method === 'direct_deposit') {
    errors.bank_account_raw = 'Account number is required for direct deposit';
  }
